...
# Stack 🖱
- [PHP 7.3 👈](https://www.php.net/ "PHP 7.3")
- [MaribaDB](https://mariadb.org/ "MaribaDB")
- [MaribaDB](https://mariadb.org/ "MaribaDB")
- [VUEJS - CDN](https://vuejs.org/v2/guide/#Getting-Started "VUEJS")
- [Bootstrap 4 - Tema Litera](https://bootswatch.com/litera/ "Litera")
# Tools 🔧
- [Font Awesone (Iconos)](https://fontawesome.com/ "Font Awesone")
- [Tiny PNG (compresor de Imagenes)](https://tinypng.com/ "Tiny")
